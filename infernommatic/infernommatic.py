...
def main():
    ...
    arg_parser.add_argument("-adapt", "--adapters_file", help = "Fasta file with all adapters to be processed", default=pkg_resources.files("infernommartic.data").joinpath("adapters.fasta"))
...
if __name__ == '__main__':
    # Isso é apenas para testar o arquivo diretamente: python seu_programa/cli.py
    main()